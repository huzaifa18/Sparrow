...
public class BSImagePicker extends BottomSheetDialogFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (GalleryUtils.isReadStorageGranted(getContext())) {
            ...
            GalleryUtils.checkPermission(BSImagePicker.this, Manifest.permission.READ_EXTERNAL_STORAGE, PERMISSION_READ_STORAGE);
        }
            ...
            adapter.setCameraTileOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (GalleryUtils.isCameraGranted(getContext()) && GalleryUtils.isWriteStorageGranted(getContext())) {
                        ...
                        if (GalleryUtils.isCameraGranted(getContext())) {
                            GalleryUtils.checkPermission(BSImagePicker.this, Manifest.permission.WRITE_EXTERNAL_STORAGE, PERMISSION_WRITE_STORAGE);
                        } else {
                            GalleryUtils.checkPermission(BSImagePicker.this, Manifest.permission.CAMERA, PERMISSION_CAMERA);
                        }
                    }
                }
            });
