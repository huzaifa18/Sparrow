...
public class MainChatGallery extends AppCompatActivity implements BSImagePicker.OnSingleImageSelectedListener,
...
//        });
    ...
    public void onSingleImageSelected(Uri uri, String tag) {
        Glide.with(MainChatGallery.this).load(uri).into(ivImage2);
    }
