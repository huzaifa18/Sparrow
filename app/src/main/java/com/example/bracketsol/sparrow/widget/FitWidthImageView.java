package com.example.bracketsol.sparrow.widget;
...
public class FitWidthImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public FitWidthImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.asksira.bsimagepicker.R.styleable.AspectRatioView, 0, 0);
        try {
            aspectRatio = a.getFloat(com.asksira.bsimagepicker.R.styleable.AspectRatioView_view_aspectRatio, 0);
        } finally {
            a.recycle();
        }
    }
